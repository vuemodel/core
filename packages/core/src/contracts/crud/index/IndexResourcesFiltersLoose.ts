...
type FilterTypeToValue = {
  [K: string]: IndexResourcesFiltersLoose | FilterTypeToValueBase | LogicalOperatorFilters
}
...
// Define IndexResourcesFiltersLoose after FilterTypeToValue so that it can reference it
export type IndexResourcesFiltersLoose = FilterTypeToValue;
